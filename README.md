...
```python
class Aufa:
    role        = "Penetration Tester (in progress)"
    ...
    currently_learning = [
        ...
        "Metasploitable → Network Exploitation",
    ...
    motto = "Don't just study security. Break things, fix things, understand why."
```
...
| Domain | Skills |
|--------|--------|
| **Offensive / Web** | SQL Injection, XSS, SSRF, File Upload Bypass, IDOR, Burp Suite |
| **Offensive / Network** | Nmap, Netcat, Metasploit Framework, Port Scanning, Enumeration |
| **Offensive / OS** | Linux Privilege Escalation, Bash Scripting, Post-Exploitation |
| **Active Directory** | BloodHound, Impacket, Kerberoasting *(in progress)* |
| **Defensive** | SOC Concepts, Threat Intelligence, CIA Triad, Log Analysis |
| **Networking** | TCP/IP, DNS, HTTP, Packet Tracer, DHCP, Wireshark |
...
> All my lab notes, exploitation writeups, and learning documentation:

[![cybersec-portfolio](https://img.shields.io/badge/Repo-cybersec--portfolio-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/aufaanggara/cybersec-portfolio)

| Target | Category | Platform | Difficulty |
|--------|----------|----------|------------|
| *(coming soon — writeups in progress)* | | | |
